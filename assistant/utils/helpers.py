...
def get_personal_assistant_home_path() -> Path:
    """Get the personal-assistant data root, overridable with PERSONAL_ASSISTANT_HOME."""
    configured = os.getenv("PERSONAL_ASSISTANT_HOME")
    if configured:
        return expand_path(configured)

    legacy_home = Path.home() / ".personal-assistant"
    migrated_home = Path.home() / "run" / ".personal-assistant"
...
def get_data_path() -> Path:
    ...
    return ensure_dir(get_personal_assistant_home_path())
...
def get_workspace_path(workspace: str | None = None) -> Path:
    ...
    Args:
        workspace: Optional workspace path. Defaults to <personal_assistant_home>/workspace.
    ...
    if workspace:
        ...
        path = get_personal_assistant_home_path() / "workspace"
