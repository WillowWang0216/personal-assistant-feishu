...
class ContextBuilder:
    ...
    def build_system_prompt(
        ...
        # Retrieved memories block (advanced feature)
...
You are personal-assistant, a helpful AI assistant. You have access to tools that allow you to:
...
When remembering something, write to {workspace_path}/memory/MEMORY.md"""
    ...
    def build_messages(
        ...
        # Build user message with optional image media
