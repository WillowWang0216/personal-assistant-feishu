...
from assistant.config.schema import MineruConfig
from assistant.utils.helpers import expand_path, get_workspace_path
        ...
        **kwargs: Any,
        ...
        def _run() -> dict[str, Any]:
            if mode == "url":
                ...
                # Upload each file using the obtained pre-signed URLs
            ...
            # Poll batch results until all files are done.
            ...
            while True:
                ...
                if extract_result:
                    ...
                    # Exit when all files are done (no unfinished states remain)
        ...
        # Download ZIP outputs for done files and build response.
...
def _format_metadata(metadata: dict[str, Any]) -> str:
    """Format metadata dict as a key-value list string."""
...
def _safe_output_name(index: int, file_name: str, data_id: Any) -> str:
    """Generate safe output directory name with index, file name, and data ID."""
