...
class ToolRegistry:
    """Registry for agent tools. Supports dynamic registration and execution."""
    ...
    async def execute(self, name: str, params: dict[str, Any]) -> str:
        ...
        parse_error = params.get("__personal_assistant_tool_args_error__")
        if parse_error:
            detail = params.get("__personal_assistant_tool_args_error_msg__", "unknown parse error")
            return (
