...
from assistant.utils.helpers import get_personal_assistant_home_path


def get_config_path() -> Path:
    """Get the default configuration file path."""
    return get_personal_assistant_home_path() / "config.json"


def get_data_dir() -> Path:
    """Get the personal-assistant data directory."""
    from assistant.utils.helpers import get_data_path
...
def _rewrite_legacy_default_paths(data: Any) -> Any:
    """Rewrite legacy ~/.personal-assistant defaults when PERSONAL_ASSISTANT_HOME points elsewhere."""
    new_home = get_personal_assistant_home_path()
    legacy_home = Path.home() / ".personal-assistant"

    if new_home == legacy_home:
        return data

    replacements = {
        "~/.personal-assistant/workspace": str(new_home / "workspace"),
        str(legacy_home / "workspace"): str(new_home / "workspace"),
        "~/.personal-assistant/media": str(new_home / "media"),
